...
BOOST_AUTO_TEST_SUITE(TestCircle)
  ...
  {
    BOOST_CHECK_THROW(Circle testCir({3.0,4.0},-6.0),std::invalid_argument);
  }
...
BOOST_AUTO_TEST_SUITE(TestRectangle)
  BOOST_AUTO_TEST_CASE(ConstantParametersAfterMoveToPoint)
  {
    Rectangle testRec({3.0,4.0},5.0,6.0);
  ...
  BOOST_AUTO_TEST_CASE(InvalidParametersInConstructor)
  {
    BOOST_CHECK_THROW(Rectangle testRec({3.0,4.0},-6.0,9.0),std::invalid_argument);
    BOOST_CHECK_THROW(Rectangle testRec({3.0,4.0},6.0,-9.0),std::invalid_argument);
    BOOST_CHECK_THROW(Rectangle testRec({3.0,4.0},-6.0,-9.0),std::invalid_argument);
  }
  BOOST_AUTO_TEST_CASE(InvalidParametersInScale)
...
BOOST_AUTO_TEST_SUITE(TestTriangle)
  BOOST_AUTO_TEST_CASE(ConstantParametersAfterMoveToPoint)
  {
    Triangle testTri({1.0,3.0},{4.0,1.0},{6.0,4.0});
