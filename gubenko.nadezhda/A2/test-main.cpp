...
const double PERMISSIBILITY = 0.0002;
...
BOOST_AUTO_TEST_SUITE(CircleTest)
  ...
  BOOST_AUTO_TEST_CASE(radius_move)
  {
    ...
    circle->move({30, 10});
    BOOST_CHECK_CLOSE(shape.getRadius(), 4, PERMISSIBILITY);
  }
  ...
  BOOST_AUTO_TEST_CASE(area_move)
  {
    ...
    gubenko::Shape *circle = & shape;
    circle->move({7, 31});
    BOOST_CHECK_CLOSE(circle->getArea(), M_PI * 16, PERMISSIBILITY);
  }
  ...
  BOOST_AUTO_TEST_CASE(area_scale)
  {
    ...
    gubenko::Shape *circle = & shape;
    circle->scale(3);
    BOOST_CHECK_CLOSE(circle->getArea(), M_PI * 144, PERMISSIBILITY);
  }
...
BOOST_AUTO_TEST_SUITE(RectangleTest)
  ...
  BOOST_AUTO_TEST_CASE(width_move)
  {
    ...
    BOOST_CHECK_CLOSE(shape.getWidth(), 4, PERMISSIBILITY);
  }
  ...
  BOOST_AUTO_TEST_CASE(height_move)
  {
    ...
    gubenko::Shape *rectangle = &shape;
    rectangle->move({0, 0});
    BOOST_CHECK_CLOSE(shape.getHeight(), 2, PERMISSIBILITY);
  }
  ...
  BOOST_AUTO_TEST_CASE(area_move)
  {
    ...
    gubenko::Shape *rectangle = &shape;
    rectangle->move({0, 0});
    BOOST_CHECK_CLOSE(rectangle->getArea(), 15, PERMISSIBILITY);
  }
  ...
  BOOST_AUTO_TEST_CASE(area_scale)
  {
    ...
    gubenko::Shape *rectangle = &shape;
    rectangle->scale(2);
    BOOST_CHECK_CLOSE(rectangle->getArea(), 24, PERMISSIBILITY);
  }
