...
BOOST_AUTO_TEST_SUITE(Matrix_tests)
  ...
  {
    suslov::Circle circle{ { 0.0, 0.0 }, 2.0 };
    suslov::Rectangle rectangle{ { 1.0, 0.0 }, 2.0, 2.0 };
    suslov::Rectangle rectangle2{ { -3.0, 0.0 }, 4.0, 4.0 };
    suslov::Circle circle2{ { 3.0, 2.0 }, 5.0 };

    std::shared_ptr< suslov::Shape > pCircle = std::make_shared< suslov::Circle >(circle);
    std::shared_ptr< suslov::Shape > pRectangle = std::make_shared< suslov::Rectangle >(rectangle);
    std::shared_ptr< suslov::Shape > pRectangle2 = std::make_shared< suslov::Rectangle >(rectangle2);
    std::shared_ptr< suslov::Shape > pCircle2 = std::make_shared< suslov::Circle >(circle2);

    suslov::Matrix matrix(pCircle);
    matrix.addShape(pRectangle);
    matrix.addShape(pRectangle2);
    matrix.addShape(pCircle2);

    std::shared_ptr < suslov::Shape > layer1_shape0 = matrix[0][0];
    std::shared_ptr < suslov::Shape > layer2_shape0 = matrix[1][0];
    std::shared_ptr < suslov::Shape > layer2_shape1 = matrix[1][1];
    std::shared_ptr < suslov::Shape > layer3_shape0 = matrix[2][0];
  ...
  BOOST_AUTO_TEST_CASE(Matrix_nullptr_shape)
  {
    ...
    BOOST_CHECK_THROW(suslov::Matrix matrix(pCircle), std::invalid_argument);
  }
BOOST_AUTO_TEST_SUITE_END()
