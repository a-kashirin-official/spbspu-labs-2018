...
starikov::Matrix objMatrix;
starikov::Rectangle matrixRect({14.0, 14.0, 7.0, 8.0});
starikov::Circle matrixCirc(8.0, {4.0, 4.0});
std::shared_ptr <starikov::Rectangle> rectPtr = std::make_shared <starikov::Rectangle> (matrixRect);
std::shared_ptr <starikov::Circle> circPtr = std::make_shared <starikov::Circle> (matrixCirc);
std::shared_ptr <starikov::CompositeShape> compPtr = std::make_shared <starikov::CompositeShape> (rectPtr);

BOOST_AUTO_TEST_SUITE(MatrixTests)

BOOST_AUTO_TEST_CASE(TestMatrixAddShape1)
{
...
BOOST_AUTO_TEST_CASE(TestMatrixAddShape2)
{
