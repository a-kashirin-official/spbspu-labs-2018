...
// Cover the test container object
struct FixtureMatrix
{
  ...
  // Test rect destructor
  ~FixtureMatrix() = default;
};

BOOST_FIXTURE_TEST_CASE(testMatrixConstructorCopy, FixtureMatrix)
{
  std::shared_ptr< hvatov::Shape > s1(new hvatov::Rectangle(100, 100, 100, 100));
  std::shared_ptr< hvatov::Shape > s2(new hvatov::Rectangle(10, 10, 100, 100));

  matr.addElement(s1);
  matr.addElement(s2);

  hvatov::Matrix buf_matr(matr);

  BOOST_CHECK_EQUAL(matr.getLayersNum(), buf_matr.getLayersNum());
  BOOST_CHECK_EQUAL(matr.getLayerSize(1), buf_matr.getLayerSize(1));
}

BOOST_FIXTURE_TEST_CASE(testMatrixConstructorMove, FixtureMatrix)
{
  std::shared_ptr< hvatov::Shape > s1(new hvatov::Rectangle(1000, 1000, 100, 100));
  std::shared_ptr< hvatov::Shape > s2(new hvatov::Rectangle(10, 10, 100, 100));

  matr.addElement(s1);
  matr.addElement(s2);

  hvatov::Matrix buf_matr(std::move(matr));

  BOOST_CHECK_EQUAL(buf_matr.getLayersNum(), 1);
  BOOST_CHECK_EQUAL(buf_matr.getLayerSize(1), 2);
  BOOST_CHECK_EQUAL(matr.getLayersNum(), 0);
}

BOOST_FIXTURE_TEST_CASE(testMatrixConstructorComp, FixtureMatrix)
{
  std::shared_ptr< hvatov::Shape > s1(new hvatov::Rectangle(1000, 1000, 100, 100));
  std::shared_ptr< hvatov::Shape > s2(new hvatov::Rectangle(10, 10, 100, 100));
  ...
  hvatov::Matrix buf_matr(cmp);

  BOOST_CHECK_EQUAL(buf_matr.getLayersNum(), 1);
  BOOST_CHECK_EQUAL(buf_matr.getLayerSize(1), 2);
  BOOST_CHECK_EQUAL(buf_matr.getElement(1, 1), s1);
  BOOST_CHECK_EQUAL(buf_matr.getElement(1, 2), s2);
}

BOOST_FIXTURE_TEST_CASE(testMatrixConstructorThrow, FixtureMatrix)
{
  BOOST_CHECK_THROW(hvatov::Matrix({nullptr}), std::invalid_argument);
}

BOOST_FIXTURE_TEST_CASE(testMatrixAssignmentCopy, FixtureMatrix)
{
  std::shared_ptr< hvatov::Shape > s1(new hvatov::Rectangle(1000, 1000, 100, 100));
  std::shared_ptr< hvatov::Shape > s2(new hvatov::Rectangle(10, 10, 100, 100));
...
BOOST_FIXTURE_TEST_CASE(testMatrixAssignmentMove, FixtureMatrix)
{
  std::shared_ptr< hvatov::Shape > s1(new hvatov::Rectangle(1000, 1000, 100, 100));
  std::shared_ptr< hvatov::Shape > s2(new hvatov::Rectangle(10, 10, 100, 100));
...
BOOST_FIXTURE_TEST_CASE(testMatrixAdd, FixtureMatrix)
{
  std::shared_ptr< hvatov::Shape > s1(new hvatov::Rectangle(1000, 1000, 100, 100));
  std::shared_ptr< hvatov::Shape > s2(new hvatov::Rectangle(10, 10, 100, 100));
  ...
  BOOST_CHECK_EQUAL(matr.getLayersNum(), 1);
  BOOST_CHECK_EQUAL(matr.getLayerSize(1), 2);
  BOOST_CHECK_EQUAL(matr.getElement(1, 1), s1);
  BOOST_CHECK_EQUAL(matr.getElement(1, 2), s2);
}

BOOST_FIXTURE_TEST_CASE(testMatrixAddComposite, FixtureMatrix)
{
  std::shared_ptr< hvatov::Shape > s1(new hvatov::Rectangle(1000, 1000, 100, 100));
  std::shared_ptr< hvatov::Shape > s2(new hvatov::Rectangle(10, 10, 100, 100));
...
BOOST_FIXTURE_TEST_CASE(testMatrixAddThrow, FixtureMatrix)
{
  BOOST_CHECK_THROW(matr.addElement(nullptr), std::invalid_argument);
}

BOOST_FIXTURE_TEST_CASE(testMatrixGetElement, FixtureMatrix)
{
  std::shared_ptr< hvatov::Shape > s1(new hvatov::Circle(10, 10, 10));
...
BOOST_FIXTURE_TEST_CASE(testMatrixGetElementThrow, FixtureMatrix)
{
  std::shared_ptr< hvatov::Shape > s1(new hvatov::Circle(10, 10, 10));

  matr.addElement(s1);

  BOOST_CHECK_THROW(matr.getElement(-1, 1), std::invalid_argument);
}

BOOST_FIXTURE_TEST_CASE(testMatrixGetLayer, FixtureMatrix)
{
  std::shared_ptr< hvatov::Shape > s1(new hvatov::Circle(10, 10, 10));
  std::shared_ptr< hvatov::Shape > s2(new hvatov::Circle(100, 100, 10));

  matr.addElement(s1);
  matr.addElement(s2);
  
  BOOST_CHECK_EQUAL(matr.getLayer(1)[0], s1);
  BOOST_CHECK_EQUAL(matr.getLayer(1)[1], s2);
}

BOOST_FIXTURE_TEST_CASE(testMatrixGetLayerThrow, FixtureMatrix)
{
  std::shared_ptr< hvatov::Shape > s1(new hvatov::Circle(10, 10, 10));

  matr.addElement(s1);

  BOOST_CHECK_THROW(matr.getLayer(-1), std::invalid_argument);
}

BOOST_FIXTURE_TEST_CASE(testMatrixGetLayersNum, FixtureMatrix)
{
  std::shared_ptr< hvatov::Shape > s1(new hvatov::Circle(10, 10, 10));
  std::shared_ptr< hvatov::Shape > s2(new hvatov::Circle(100, 100, 10));
...
BOOST_FIXTURE_TEST_CASE(testMatrixGetLayerSize, FixtureMatrix)
{
  std::shared_ptr< hvatov::Shape > s1(new hvatov::Circle(10, 10, 10));
  std::shared_ptr< hvatov::Shape > s2(new hvatov::Circle(100, 100, 10));
...
BOOST_FIXTURE_TEST_CASE(testMatrixGetLayerSizeThrow, FixtureMatrix)
{
  std::shared_ptr< hvatov::Shape > s1(new hvatov::Circle(10, 10, 10));

  matr.addElement(s1);

  BOOST_CHECK_THROW(matr.getLayerSize(-1), std::invalid_argument);
}

BOOST_FIXTURE_TEST_CASE(testMatrixClear, FixtureMatrix)
{
  std::shared_ptr< hvatov::Shape > s1(new hvatov::Circle(10, 10, 10));
  std::shared_ptr< hvatov::Shape > s2(new hvatov::Circle(100, 100, 10));
