...
void kashirin::task1(int argc, const char *const argv[])
{
  if (argc <= 2) {
  ...
  std::vector<int> ints = kashirin::detail::readValues<int>(std::cin);
  
  std::vector<int> copyOfInput = ints;
  kashirin::detail::sort<kashirin::detail::BracketAccess>(copyOfInput, ascending);
  kashirin::detail::printValues(std::cout, copyOfInput, " ", true);

  copyOfInput = ints;
  kashirin::detail::sort<kashirin::detail::AtAccess>(copyOfInput, ascending);
  kashirin::detail::printValues(std::cout, copyOfInput, " ", true);
  
  std::forward_list<int> lst(ints.begin(), ints.end());
  kashirin::detail::sort<kashirin::detail::IteratorAccess>(lst, ascending);
  kashirin::detail::printValues(std::cout, lst, " ", true);
}

void kashirin::task2(int argc, const char *const argv[])
{
  if (argc <= 2) {
  ...
  kashirin::detail::printValues(std::cout, vector, "", false);
}

void kashirin::task3(int, const char *const[])
{
  using std::cin;
  ...
  kashirin::detail::printValues(std::cout, ints, " ", true);
}

void kashirin::task4(int argc, const char *const argv[])
{
  if (argc <= 3) {
  ...
  kashirin::fillRandom(doubles.get(), size);

  std::cout << std::setprecision(2) << std::fixed;
  std::vector<double> values(doubles.get(), doubles.get() + size);
  kashirin::detail::printValues(std::cout, values, " ", true);

  kashirin::detail::sort<kashirin::detail::BracketAccess>(values, ascending);
  kashirin::detail::printValues(std::cout, values, " " , true);
}
